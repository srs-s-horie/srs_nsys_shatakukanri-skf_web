...
<script type="text/javascript">
		...
		<div class="imui-form-container-wide" width="1350px" style="width: 100%; min-width:1300px;max-width: 1350px;">
			<div class="imui-form-container-wide"  style="width:1280px;">
				<div class="imui-chapter-title" style="width:35%;"><h2>退居（自動車の保管場所返還）届連携データ情報</h2></div>
					...
					<nfwui:Table use="search">
						<tbody>
							...
							<tr>
								...
								<td style="width: 20%;">
								<imui:textbox id="applNo" name="applNo" style="width: 95%;" value="${form.applNo}" placeholder="帳票ID＋社員番号＋日付＋枚数(26桁以内)"  tabindex="3" />
								</td>
								<td style="border:none">
								</td>
							</tr>
							...
							<tr>
								...
								<td style="width: 20%;">
								<imui:textbox id="userID" name="userID" style="width: 95%;" value="${form.userID}" placeholder="ユーザID"  tabindex="3" />
								</td>
								<td style="border:none">
								</td>
							</tr>
			...
			<div class="align-R">
				<nfwui:Button id="registe" name="registe" value="検索" cssClass="imui-medium-button" 
						url="skf/Skf2040Fc001/execute" formId="form" tabindex="8" />
			</div>
		</div>
	<!-- コンテンツエリア　ここまで -->