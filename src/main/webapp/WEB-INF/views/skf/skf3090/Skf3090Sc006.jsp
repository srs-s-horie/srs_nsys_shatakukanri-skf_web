			...
			<div class="imui-form-container-wide" style="width:95%;">
						...
						<tbody>
							<tr>
								...
								<td style="width: 15%;">
									...
									width="185" list="${form.companyList}" tabindex="1" />
								</td>
								<th style="width: 10%;">
								...
								<td style="width: 15%;">
									...
									width="185" list="${form.agencyList}" tabindex="2" />
								</td>
								...
								<td style="width: 15%;">
									...
									width="185" list="${form.businessAreaList}" tabindex="3" />
								</td>
							</tr>
							<tr>
								...
								<td style="width: 15%;">
									...
									width="185" list="${form.affiliation1List}" tabindex="4" />
								</td>
								...
								<td style="width: 15%;">
									...
									width="185" list="${form.affiliation2List}" tabindex="5" />
								</td>
				...
				<div class="align-L">	
					<nfwui:Button id="search" name="search" value="検索" cssClass="imui-small-button"
						url="skf/Skf3090Sc006/search" formId="form" tabindex="6" />
				</div>
			...
			<div class="imui-form-container-wide"  style="width:95%;">
				...
				<nfwui:Form id="form2" name="form2"  modelAttribute="form">
					...
					<imui:listTable id="mainList" process="java" autoEncode="true" autoWidth="true"
						...
						<col name="affiliation1Name" caption="部等" width="250" align="left" />
						<col name="affiliation2Name" caption="室、チーム又は課"　width="300" align="left" />
